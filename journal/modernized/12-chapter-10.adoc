...
All tender Friends, whose faces are turned from the world towards Zion,
...
And you that are not only turned towards Zion,
but have been and are travellers in the way,
