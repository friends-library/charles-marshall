...
out of the nature that keeps the soul in any bondage and distance from the Lord,_ Yes,
...
incorruptible seed which bruises the serpent`'s head: of which seed all must be born,
