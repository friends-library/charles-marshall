...
out of the nature that keeps the soul in any bondage and distance from the Lord, Yea,
...
incorruptible seed which bruiseth the serpents head: of which seed all must be born,
